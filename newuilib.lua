...
function module:New(name)
	...
	window.__index = window
        ...
        Main.BorderColor3 = Color3.fromRGB(0, 153, 0)
        ...
        tabbuttons.ScrollBarImageColor3 = Color3.fromRGB(0, 153, 0)
		...
		greetings.Text = 'Welcome, ' .. game.Players.LocalPlayer.DisplayName
		greetings.TextColor3 = Color3.fromRGB(255, 255, 255)
		greetings.BackgroundTransparency = 1
		greetings.TextSize = 14
		
		local size = (game:GetService('TextService'):GetTextSize('Welcome, ' .. game.Players.LocalPlayer.DisplayName, 14, Enum.Font.Ubuntu, Vector2.new(Main.Size))).X
        ...
        function window:NewTab(namee)
            ...
            tabbutton.BackgroundColor3 = Color3.fromRGB(0, 153, 0)
			...
			tabbutton.MouseEnter:Connect(function()
				tween(tabbutton,TweenInfo.new(0.4,Enum.EasingStyle.Linear),{BackgroundColor3 = Color3.fromRGB(0, 153, 0)})
			end)
            ...
            ScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(0, 153, 0)
            ...
            function tab:NewSearchBar()
                ...
                SearchBar.BackgroundColor3 = Color3.fromRGB(0, 153, 0)
			...
			button.ZIndex = 0
				...
				button.MouseButton1Down:Connect(function()
					...
					tween(button,TweenInfo.new(0.2,Enum.EasingStyle.Linear), {BackgroundColor3 = Color3.fromRGB(0, 153, 0)})
				end)
				...
				button.MouseLeave:Connect(function()
					if holding and not clicked then tween(button,TweenInfo.new(0.2,Enum.EasingStyle.Linear), {BackgroundColor3 = Color3.fromRGB(0, 153, 0)}) end
				end)
                ...
                infobutton.MouseButton1Click:Connect(function()
                    ...
                    if clicked then
						...
						tween(button,TweenInfo.new(0.2,Enum.EasingStyle.Linear), {BackgroundColor3 = Color3.fromRGB(0, 0, 0)})
                    else 
                        button.Text = name
                        button.TextSize = 17.000
						tween(button,TweenInfo.new(0.2,Enum.EasingStyle.Linear), {BackgroundColor3 = Color3.fromRGB(0, 153, 0)})
	...
	function window:NewCommandBar(label)
		...
		function cmd:AddCommand(name, args, description, callback)
			...
			thinggy.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
