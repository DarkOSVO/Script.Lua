    ...
    function Tabs:NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                moreInfo.ZIndex = 9
                moreInfo.Font = Enum.Font.SarpanchSemibold
                ...
                btnInfo.Font = Enum.Font.SarpanchSemibold
                btnInfo.Text = bname
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                togName.Font = Enum.Font.SarpanchSemibold
                togName.Text = tname
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                val.Font = Enum.Font.SarpanchSemibold
                val.Text = minvalue
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                itemTextbox.Font = Enum.Font.SarpanchSemibold
                ...
                for i,v in next, list do
                    ...
                    optionSelect.Font = Enum.Font.SarpanchSemibold
                    optionSelect.Text = "  "..v
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                togName_2.Font = Enum.Font.SarpanchSemibold
