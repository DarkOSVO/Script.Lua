...
function module:New(name)
	...
	window.__index = window
        ...
        UIStroke.Color = Color3.fromRGB(1, 255, 10)
		...
		greetings.TextColor3 = Color3.fromRGB(11, 255, 3)
		...
		selected.SoundId = 'rbxassetid://3314301672' - activation scripts

		local tabselected = Instance.new('Sound', Main)
		tabselected.SoundId = 'rbxassetid://6228296129' - click library
        ...
        function window:NewTab(namee)
			...
			function tab:NewBoolButton(name, desc, callback, toggled)
				...
				slider.Name = "slider"
				slider.BackgroundColor3 = Color3.fromRGB(0, 255, 17)
				...
				button.MouseButton1Click:Connect(function()
					...
					if not pressed then
						...
						tween(slider,TweenInfo.new(0.2,Enum.EasingStyle.Linear), {BackgroundColor3 = Color3.fromRGB(0, 255, 17)})
						callback(pressed)
					else
